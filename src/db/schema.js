...
export const user = sqliteTable("user", {
  id: integer("id").primaryKey().$default(() =>  randomUUID()),
...
export const collection = sqliteTable("collection", {
    id: integer("id").primaryKey().$default(() => randomUUID()),
    owner_id : integer("owner_id").notNull().references(() => user.id, {onDelete: "cascade"}),
...
export const flashcard = sqliteTable("flashcard", {
    id: integer("id").primaryKey().$default(() => randomUUID()),
    collection_id : integer("collection_id").notNull().references(() => collection.id, {onDelete: "cascade"}),
...
export const study = sqliteTable("study", {
    ...
    flashcard_id : integer("flashcard_id").notNull().references(() => flashcard.id, {onDelete: "cascade"}),
